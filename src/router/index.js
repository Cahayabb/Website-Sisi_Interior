...

{
  ...
  children: [
    ...
    },
    {
      ...
      meta: { title: 'Portfolio', requiresAuth: true, role: 'admin' },
    },
    {
      path: 'proyek',
      name: 'admin-proyek',
      component: () => import('../views/admin/Project.vue'),
      meta: { title: 'Data Proyek', requiresAuth: true, role: 'admin' },
    },
    {
      path: 'training',
      name: 'admin-training',
      component: () => import('../views/admin/Training.vue'),
      meta: { title: 'Training Model', requiresAuth: true, role: 'admin' },
    },
    {
      path: 'estimasi',
      name: 'admin-estimasi',
      component: () => import('../views/admin/EstimasiBiaya.vue'),
      meta: { title: 'Estimasi Biaya', requiresAuth: true, role: 'admin' },
    },
    {
      path: 'analitik',
      name: 'admin-analitik',
      component: () => import('../views/admin/Analitik.vue'),
      meta: { title: 'Dashboard Analitik', requiresAuth: true, role: 'admin' },
    },
  ],
},
